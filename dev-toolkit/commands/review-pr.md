...
Analyze the following pull request: $ARGUMENTS

**OBJECTIVE:**
Use the pragmatic-code-review agent to comprehensively review the pull request changes.
...
**CRITICAL:** Provide feedback directly on GitHub pull request, with inline comments and/or pull request comments.